  ...
  <TelephoneWin>
    <div class="video-content">
      ...
      <div class="left">
        ...
        <div class="list" ref="listContent">
          <div
            class="tips"
            style="font-size: 12px; color: #989696; padding: 3px; line-height: 18px"
          >
            温馨提示: 1、请自行调节音量至合适的状态。2、直播界面显示屏幕共享发起者的屏幕内容,
    ...
    <template #footer>
      <div class="logout" @click="logout">
        ...
        <div class="text">
          {{ userInfoStore.userInfo._id === $route.query.fId ? '结束通话' : '退出通话' }}
        </div>
      </div>
    </template>
  </TelephoneWin>
